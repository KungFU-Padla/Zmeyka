...
class Game
{
    ...
    public void Main()
    {
        walls = new Walls((int)Size.Right, (int)Size.Down, '!');
        snake = new Snake((int)Size.Right / 2, (int)Size.Down / 2, 3);

        foodFactory = new FoodFactory((int)Size.Right, (int)Size.Down, '$ ');
